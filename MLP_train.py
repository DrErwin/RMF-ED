...
:LastEditTime: 2025-02-21 14:25:13
:Description: 
'''
import torch
import argparse
...
def main(args):
    EPOCH = args.epoch
    KITTI_TRAIN_PATH = args.kitti_path
    ...
    for epoch in tqdm(range(EPOCH), desc='Epoch'):
        ...
        if epoch % 3 == 0:
            torch.save({'epoch': epoch,
                ...
                'loss': sum_loss / idx}, os.path.join(ckpt_path, f'epoch_{epoch+1}.pth'))

if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Configuration Parameters')
    parser.add_argument('--kitti_path', default='/mnt/ssd1/lifa_rdata/det/kitti', 
                        help='your data root for kitti')
    parser.add_argument('--save_path', default='./', help='path to save your checkpoints')
